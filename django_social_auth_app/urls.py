...
urlpatterns = [
    ...
    path(r'update_repository/<repository_id>', repository_views.update_repository, name='update_repository'),
    path(r'remove_repository/<repository_id>', repository_views.remove_repository, name='remove_repository'),
